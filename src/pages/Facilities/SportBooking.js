...
const SportBooking = () => {
  ...
  const getAllBooking = async () => {
    try {
      let res = await axios.get("http://localhost:8000/api/sportbooking");
      if (res.status == 200) {
  ...
  const handleOk = async () => {
    try {
      ...
      let res = await axios.post(
        "http://localhost:8000/api/sportbooking",
        {
          ...values,
    ...
    <div className="facility-bookings-container">
      ...
      >
        ...
        >
                    ...
                    >
                      ...
                      <a
                        onClick={() => {
                          ...
                          const currentPeopleDetails =
                            form.getFieldValue("person");
                          form.setFieldsValue({
                            people: currentPeopleDetails.length,
                          });
                        }}
                        style={{
                          color: "red",
          ...
          {/* Payment Status */}
          <Form.Item name="paymentsStatus" label="Payment Status">
