    ...
    form
      ...
      .then(async (values) => {
        try {
          ...
          const formData = {
            ...values,
            reservationType: "Bar", // Set the appropriate value
          };
  ...
  return (
    <div className="main-content">
      <div className="view-menu-content flex justify-between items-center">
        <h2 className="menu-title">Bar Reservation</h2>
      ...
      >
        <Form form={form} layout="vertical" name="reservationForm">
          ...
          <Form.Item name="memberEmail" label="Email">
            <Input />
          </Form.Item>
          ...
          <Form.Item name="referedBy" label="Referred By">
            <Input />
          </Form.Item>
          <Form.Item name="referedById" label="Referred By ID">
            <Input />
          </Form.Item>
          ...
          <Form.Item
            ...
            name="status"
            rules={[{ required: true, message: "Select reservation status" }]}
          >
